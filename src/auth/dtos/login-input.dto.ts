...
export const loginInputSchema = z
  ...
  .refine(
    (loginDto) =>
      loginDto.employeeId || loginDto.employeeEmail || loginDto.employeeDni,
    {
      message:
        'At least one of the following fields must be provided: `employeeId`, `employeeEmail`, `employeeDni`',
